...
var MethodGenerator = /** @class */ (function () {
    ...
    MethodGenerator.prototype.generate = function () {
        ...
        var responses = this.mergeResponses(this.getMethodResponses(), this.getMethodSuccessResponse(type));
        return {
    ...
    MethodGenerator.prototype.getMethodSecurity = function () {
        ...
        return securityDecorators.map(function (d) { return ({
            name: d.arguments[0],
